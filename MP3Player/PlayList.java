...
*
*This class has recieved minor modifications and now it is able to
*recieve input in form of an Iterable array
*/
...
public class PlayList implements Observer {
     ...
     * from the filenames.
     *
     * @param fileNames The Iterable array of audio filenames for this play list.
     */
    public PlayList(Iterable<String> fileNames) {
         // read through all String elements within the array and add them to the list of sources
